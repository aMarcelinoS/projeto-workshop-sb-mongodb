package com.example.workshopmongosbjava.config;
...
import com.example.workshopmongosbjava.dto.AuthorDTO;
import com.example.workshopmongosbjava.dto.CommentDTO;
...
public class Instatiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", sdf.parse("23/0/2020"), new AuthorDTO(alex));
